export const footer = {
  "contact": {
    "address": "Bazulla Road, T. Nagar, Chennai, Tamil Nadu 600017",
    "emails": [
      {
  ...
  "descriptor": "A diversified infrastructure organization developing, owning and managing institutional-grade industrial and institutional assets since 1954.",
  "ecosystem": [
    {
      "external": true,
